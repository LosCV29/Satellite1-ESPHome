...
async def to_code(config):
    ...
    if CORE.is_esp32:
        ...
        # Without this, ESPHome >=2026.9 fails to build with:
        #   http_request_idf.h ... includes esp_tls.h, provided by esp-tls
        #   component(s). However, esp-tls component(s) is not in the
        #   requirements list of "src".
        # Matches the upstream fix in esphome 2026.9.0.
